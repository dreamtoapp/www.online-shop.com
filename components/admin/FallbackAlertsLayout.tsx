...
import { AlertTriangle, Zap } from 'lucide-react'; // Import directly
import { iconVariants } from '@/lib/utils'; // Import CVA variants

// Removed Icon import: import { Icon } from '../icons';
          ...
          {alerts.map((alert) => (
            ...
            >
              <div className='flex items-center gap-2'>
                <Zap className={iconVariants({ size: 'sm', animation: 'pulse', className: 'text-yellow-400' })} /> {/* Use direct import + CVA */}
